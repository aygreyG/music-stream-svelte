...
CREATE TABLE "Listened" (
    "id" TEXT NOT NULL,
    "listeningTime" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "FolderScan" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "scanLength" DOUBLE PRECISION NOT NULL,
    "newTracks" INTEGER NOT NULL,
    "serverSettingsId" TEXT NOT NULL,

    CONSTRAINT "FolderScan_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Album" ADD CONSTRAINT "Album_albumArtistId_fkey" FOREIGN KEY ("albumArtistId") REFERENCES "Artist"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Listened" ADD CONSTRAINT "Listened_trackId_fkey" FOREIGN KEY ("trackId") REFERENCES "Track"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Listened" ADD CONSTRAINT "Listened_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Playlist" ADD CONSTRAINT "Playlist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FolderScan" ADD CONSTRAINT "FolderScan_serverSettingsId_fkey" FOREIGN KEY ("serverSettingsId") REFERENCES "ServerSettings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
